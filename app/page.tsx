...
const initialShopItems: ShopItem[] = [
  ...
  },
  {
    ...
    description: "Pack of 10 premium hongbao for Lunar New Year",
    price: 8.00,
    image: "🧧",
    category: "Stationery",
    inStock: true,
  ...
  },
  {
    id: "3",
    name: "Club Hoodie",
    description: "Warm fleece hoodie with embroidered club logo",
    price: 35.00,
    image: "🧥",
    category: "Apparel",
    inStock: true,
  ...
  {
    id: "4",
    name: "Boba Sticker Pack",
    description: "Waterproof vinyl stickers featuring cute boba designs",
    price: 5.00,
    image: "🧋",
    category: "Stationery",
    inStock: true,
  ...
  {
    id: "5",
    name: "Mooncake Keychain",
    description: "Adorable plush keychain shaped like a mooncake",
    price: 7.00,
    image: "🥮",
  ...
  },
  {
    id: "6",
    name: "Folding Fan",
    description: "Bamboo folding fan with hand-painted cherry blossoms",
    price: 12.00,
    image: "🪭",
    category: "Accessories",
    inStock: true,
  ...
  {
    id: "7",
    name: "Heritage Pin Set",
    description: "Enamel pins celebrating AAPI cultures",
    price: 10.00,
    originalPrice: 15.00,
    image: "📍",
    category: "Accessories",
  ...
  {
    id: "8",
    name: "Mochi Eraser Set",
    description: "Cute mochi-shaped erasers in pastel colors",
    price: 4.00,
    image: "🍡",
    category: "Stationery",
    inStock: true,
